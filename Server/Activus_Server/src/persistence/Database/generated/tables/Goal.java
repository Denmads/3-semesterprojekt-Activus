...
public class Goal extends TableImpl<GoalRecord> {
    ...
    private static final long serialVersionUID = -1207511689;
     ...
     */
    public final TableField<GoalRecord, Integer> WEIGHT = createField(DSL.name("weight"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.INTEGER)), this, "");
