...
public class Exercise extends TableImpl<ExerciseRecord> {
    ...
    private static final long serialVersionUID = -2105221290;
     ...
     */
    public final TableField<ExerciseRecord, Long> TIME_TAKEN = createField(DSL.name("time_taken"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.exercise.rebs</code>.
     */
    public final TableField<ExerciseRecord, Integer> REBS = createField(DSL.name("rebs"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.exercise.sets</code>.
     */
    public final TableField<ExerciseRecord, Integer> SETS = createField(DSL.name("sets"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.exercise.weight</code>.
     */
    public final TableField<ExerciseRecord, Integer> WEIGHT = createField(DSL.name("weight"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.INTEGER)), this, "");
